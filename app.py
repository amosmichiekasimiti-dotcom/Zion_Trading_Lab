...
# Assets including all volatilities and 1S markets
...
def home():
    ...
    try:
        ...
        action, acc, expiry, reason = "CALL/OVER", "98%", "5 Ticks", "Trend Analysis complete."
...
<head>
    ...
    <style>
        ...
        .navbar { background: var(--nav); padding: 12 daring; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid rgba(255,255,255,0.1); }
        ...
        /* SCROLLABLE NAV */
        .slider { display: flex; flex-wrap: nowrap; overflow-x: auto; background: var(--nav); padding: 12px 15px; gap: 20px; border-bottom: 1px solid rgba(255,255,255,0.1); scrollbar-width: none; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="broadcast-box">
            ...
            <input type="text" id="customText" placeholder="Message for users...">
    ...
    <script>
        let isMuted = false;
        function playAI(text) { if (!isMuted) { const msg = new SpeechSynthesisUtterance(text); window.speechSynthesis.speak(msg); } }
...
""" # <--- THIS CLOSES THE HTML STRING CORRECTLY
